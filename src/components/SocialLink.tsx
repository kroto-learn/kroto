...
const SocialLink = ({ href, type = "other", children, collapsed }: Props) => {
  return (
    <a
      className={`flex cursor-pointer items-center gap-2 border border-neutral-600 bg-white/10 px-3 py-2 font-medium text-neutral-200 duration-300 hover:bg-neutral-200 hover:text-black ${
