  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col items-start gap-2 xs:w-3/5">
        <h5 className="text-base font-medium tracking-tight line-clamp-1 text-ellipsis overflow-hidden text-neutral-200 transition-all xs:text-sm sm:text-base lg:text-lg">
          {event?.title}
        </h5>
...
export const EventCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col items-start gap-2 xs:w-3/5">
        <h5 className="text-base font-medium line-clamp-2 text-ellipsis tracking-tight text-neutral-200 transition-all xs:text-sm sm:text-base lg:text-lg">
          {event?.title}
        </h5>
