      ...
      <div className="flex justify-center">
        <div className="flex rounded-full border-2 border-neutral-700">
          <span
            ...
            }  rounded-l-full border border-r-0 border-neutral-600 bg-neutral-800 text-lg shadow`}
          >
          ...
          <input
            type="text"
            id="website-admin"
            className={`block w-min rounded-none rounded-r-full border border-l-0 border-neutral-600 bg-neutral-800 ${
              variant === "sm" ? "p-2" : "p-4"
            } pl-1 ${
              variant === "lg"
                ? "text-2xl"
                ...
                ? "text-lg"
                : "text-md"
            } placeholder-neutral-400 shadow outline-none ring-transparent focus:border-neutral-700 focus:ring-neutral-700 active:outline-none active:ring-transparent`}
