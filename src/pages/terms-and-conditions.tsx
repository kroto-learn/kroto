        ...
        <div className="flex flex-grow flex-col gap-3">
          <div className="flex min-h-[20px] flex-col items-start gap-4 whitespace-pre-wrap">
            <div className="prose prose-invert w-full break-words">
              ...
              <p>Welcome to Kroto!</p>

              <p>
                These terms and conditions outline the rules and regulations for
                the use of Kroto Kreator Labs Private Limited&apos;s Website,
                located at https://www.kroto.in.
              </p>

              <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Kroto if you do not agree to
              ...
              <p>
                ...
                accordance with and subject to, prevailing law of in. Any use of
              ...
              <p>
                We employ the use of cookies. By accessing Kroto, you agreed to
                use cookies in agreement with the Kroto Kreator Labs Private
              ...
              <p>
                Unless otherwise stated, Kroto Kreator Labs Private Limited
                and/or its licensors own the intellectual property rights for
                all material on Kroto. All intellectual property rights are
                reserved. You may access this from Kroto for your own personal
                use subjected to restrictions set in these terms and conditions.
              </p>

              <p>You must not:</p>
              <ul>
                <li>Republish material from Kroto</li>
                <li>Sell, rent or sub-license material from Kroto</li>
                <li>Reproduce, duplicate or copy material from Kroto</li>
                <li>Redistribute content from Kroto</li>
              </ul>
              ...
              <p>
                ...
                website. Kroto Kreator Labs Private Limited does not filter,
                edit, publish or review Comments prior to their presence on the
                website. Comments do not reflect the views and opinions of Kroto
                Kreator Labs Private Limited,its agents and/or affiliates.
                ...
                laws, Kroto Kreator Labs Private Limited shall not be liable for
              ...
              <p>
                Kroto Kreator Labs Private Limited reserves the right to monitor
              ...
              <p>
                You hereby grant Kroto Kreator Labs Private Limited a
              ...
              <p>
                ...
                of Kroto Kreator Labs Private Limited; and (d) the link is in
              ...
              <p>
                ...
                by sending an e-mail to Kroto Kreator Labs Private Limited.
              ...
              <p>
                No use of Kroto Kreator Labs Private Limited&apos;s logo or
