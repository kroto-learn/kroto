        ...
        <div className="flex flex-grow flex-col gap-3">
          <div className="flex min-h-[20px] flex-col items-start gap-4 whitespace-pre-wrap">
            <div className="prose prose-invert w-full break-words">
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Kroto Kreator
                    Labs Private Limited, PBT BY PASS ROAD, STREET NO-3,
                    PN/11/14/2, Shamat Ganj, Bareilly, Bareilly-243005, Uttar
                    Pradesh.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Kroto, accessible from{" "}
                    <a
              ...
              <h2 id="google_limited_use_policy">
                We comply with Google&apos;s Limited Use Policy
              </h2>
              <p>
                Kroto&apos;s use and transfer to any other app of information
